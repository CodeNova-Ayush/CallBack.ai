...
import { ShieldCheck, Mail, Lock, ArrowRight, User, CheckCircle2 } from 'lucide-react';
          ...
          <div className="w-full bg-white border border-slate-200/90 rounded-3xl p-8 shadow-xl shadow-slate-200/50 flex flex-col gap-5">
            <div className="flex flex-col text-left">
              <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-emerald-50 text-emerald-700 text-[10px] font-black uppercase tracking-wider rounded-full w-fit mb-2">
                <CheckCircle2 className="w-3 h-3" /> New Candidate Sign Up
              </div>
              <h2 className="text-2xl font-black text-slate-950">Create Your Account</h2>
              <p className="text-xs text-slate-500 mt-1 font-medium">
                Choose your signup method to verify and proceed to the resume setup gateway.
              </p>
            </div>
            ...
            <form onSubmit={handleAuthSubmit} className="flex flex-col gap-3.5">
              ...
              >
                <span>{isSubmitting ? 'Creating Account & Entering...' : 'Sign Up & Continue'}</span>
